...
![Workspace Dashboard with dotted red line around buttons for browser-based tools](../images/workspace-annotated.png){fig-alt="Workspace Dashboard with dotted red line around buttons for browser-based tools"}
