...
![Workspace Ports Menu](../images/ports-menu.png){fig-alt="Workspace Ports Menu" width=50%}

From the Marimo dashboard, you can create a new notebook, which will be saved in your project folder.

![Marimo Dashboard](../images/marimo-dashboard.png){fig-alt="Marimo Dashboard" width=75%}
...
![Adding a model in the AI Models tab](../images/marimo-add-model.png){fig-alt="Adding a model in the AI Models tab" width=60%}
...
![AI Features configuration](../images/marimo-ai-features.png){fig-alt="AI Features configuration" width=60%}
...
![Marimo chat panel](../images/marimo-chat.png){fig-alt="Marimo chat panel" width=50%}
