...
![Coder Workspace Dashboard](../images/workspace.png){fig-alt="Coder Workspace Dashboard"}
...
![File Browser UI](../images/file-browser.png){fig-alt="File Browser UI" width=70%}
