...
To use an AI coding agent, you typically need an account from a model
provider like Google, OpenAI, or Anthropic. UCSB faculty and staff can use
their UCSB email to authenticate Google's Gemini CLI. Unfortunately, UCSB students
cannot access Gemini using their UCSB accounts at this time.
