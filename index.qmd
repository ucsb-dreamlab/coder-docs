...
| :--------------------------------------------- | :---------- | :-------------------------- |
| [Ubuntu Linux](https://ubuntu.com/)            | 24.04.4 LTS | Operating System            |
| [Docker](https://docs.docker.com/get-started/) | 29.3.1      | Container Runtime           |
| [Pixi](https://pixi.sh/latest/)                | v0.65.0     | Python package manager      |
| [R](https://www.r-project.org/)                | v4.5.3      | R programming language      |
| Git                                            | v2.43.0     | Version control software    |
| `gh`                                           | v2.89.0     | Github CLI                  |
| `jq`                                           | v1.7        | Command line JSON processor |
| `duckdb`                                       | v1.5.0      | DuckDB command line tool    |
| `uv` / `uvx`                                   | 0.10.9      | Python package installer/runner |
...
| :---------------------------------------------------------------------------------- | :--------- | :------------------------------------- |
| RStudio Server                                                                      | v2026.01.1 | Run RStudio in the browser             |
