...
workspace to use for the duration of the academic quarter. Workspaces are deleted at the end of each quarter. The service is managed by the [Library DREAM Lab](https://www.library.ucsb.edu/dreamlab) and uses computing resources provided by the [College of Letters and Science IT](https://www.lsit.ucsb.edu)

See our [**Getting Started Guide**](guides/getting-started.qmd) for an introduction to using Coder Workspaces.
...
| :--------------------------------------------- | :---------- | :-------------------------- |
| [Ubuntu Linux](https://ubuntu.com/)            | 26.04 LTS   | Operating System            |
| [Docker](https://docs.docker.com/get-started/) | 29.6.0      | Container Runtime           |
| [Pixi](https://pixi.sh/latest/)                | v0.70.2     | Python package manager      |
| [R](https://www.r-project.org/)                | v4.6.0      | R programming language      |
| Git                                            | v2.53.0     | Version control software    |
| `gh`                                           | v2.46.0     | Github CLI                  |
| `jq`                                           | v1.8.1      | Command line JSON processor |
| `duckdb`                                       | v1.5.4      | DuckDB command line tool    |
| `uv` / `uvx`                                   | 0.11.23     | Python package installer/runner |
...
| :---------------------------------------------------------------------------------- | :--------- | :------------------------------------- |
| RStudio Server                                                                      | v2026.05.0 | Run RStudio in the browser             |
| [VS Code Web](https://github.com/coder/code-server)                                 | -          | Run VS Code in the browser             |
| [VS Code Desktop (Server)](https://code.visualstudio.com/docs/remote/vscode-server) | -          | Connect to the workspace using VS Code |
